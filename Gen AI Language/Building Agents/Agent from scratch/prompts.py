...
If no tool, just provide a respone to the query.

Here is a list of your tools along with their descriptions:
{tool_description}

Please make a decision based on the provided user query and the available tools and just return valid json string.
"""